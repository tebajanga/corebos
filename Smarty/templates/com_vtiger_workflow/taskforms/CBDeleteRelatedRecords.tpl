...
<h2>{'CBDeleteRelatedRecords'|@getTranslatedString}</h2>
...
<img src="{'select.gif'|@vtiger_imageurl:$THEME}" tabindex="1" alt="{'CBDeleteRelatedRecords'|@getTranslatedString}" title="{'CBDeleteRelatedRecords'|@getTranslatedString}"
